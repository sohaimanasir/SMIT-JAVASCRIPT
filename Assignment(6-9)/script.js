...
// var m1 = parseInt(prompt("Enter marks for " + sub1));
// var m2 = parseInt(prompt("Enter marks for " + sub2));
// var m3 = parseInt(prompt("Enter marks for " + sub3));

// var totalObtained = m1 + m2 + m3;
// var total = totalMarks * 3;
// var percentage = (totalObtained / total) * 100;

// document.write("Subject   Total   Obtained   Percentage");

// document.write(sub1 + "   " + totalMarks + "   " + m1 + "   " + (m1/totalMarks*100) + "%" +"<br>");
// document.write(sub2 + "   " + totalMarks + "   " + m2 + "   " + (m2/totalMarks*100) + "%" + "<br>");
// document.write(sub3 + "   " + totalMarks + "   " + m3 + "   " + (m3/totalMarks*100) + "%" + "<br>");

// document.write("Total: " + total + "   " + totalObtained + "   " + percentage + "%");
